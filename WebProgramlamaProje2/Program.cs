...
var connectionString = builder.Configuration.GetConnectionString("WebProjeDBContextConnection") ?? throw new InvalidOperationException("Connection string 'WebProjeDBContextConnection' not found.");
